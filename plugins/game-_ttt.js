...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} GANASTE 🥳, TE LLEVAS +4999 exp` : isTie ? 'EL JUEGO TERMINO EN UN EMPAT 😐' : `TURNO DE @${room.game.currentTurn.split('@')[0]}`}
`.trim()
